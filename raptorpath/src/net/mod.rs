...
///
/// **The correction is available behind `RWM_SUM_CAP`** (paper §16.60): this
...
/// The `[SUMCAP]` line — the `×N` deletion's engagement echo (paper §16.60).
///
...
async fn run_window_sender(
    ...
    // `[SUMCAP]` (paper §16.60): the `×N` deletion's engagement echo. Fed on
